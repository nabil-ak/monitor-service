...
class svd:
    ...
    def scrape_site(self,headers, proxy):
        """
    ...
    def monitor(self):
        ...
        while True:
            try:
                ...
                items = self.scrape_site(headers, proxy)
                products = []
