...
class magento:
    def __init__(self,groups,site,store_id,url,user_agent,delay=1,keywords=[],proxys=[],blacksku=[]):
        ...
        self.proxys = proxys
        self.proxytime = 999999999999999999999999999
    ...
    def scrape_site(self,page, proxy):
        ...
        html = scraper.get(f'{self.url}/V1/products-render-info?searchCriteria[pageSize]=100&storeId={self.store_id}&currencyCode=EUR&searchCriteria[currentPage]={page}&searchCriteria[filter_groups][0][filters][0][field]=name&searchCriteria[filter_groups][0][filters][0][value]={random.randint(10000,999999)}&searchCriteria[filter_groups][0][filters][0][condition_type]=nin', timeout=10)
